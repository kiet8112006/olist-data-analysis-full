...
Orders_clean.loc[Orders_clean['order_delivered_carried_date'] > Orders_clean['order_delivered_customer_date'], 'is_invalid_date']=1
...
# Save  cleaned file
Orders_clean.to_csv(r'C:\Users\ADMIN\Desktop\Olist\Orders_clean.csv', index=False)
